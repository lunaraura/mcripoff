local SpeciesConfig = {
	...
	cinderpup = {
		...
		baseStats = { pAtk = 10, eAtk = 6, range = 24, maxHP = 102, spd = 14.5, castSpd = 1.0, size = 4, stamina = 24, energy = 14, recoverStamina = 1.9, recoverEnergy = 1.4 },
	...
	glintswift = {
		...
		baseStats = { pAtk = 5, eAtk = 11, range = 110, maxHP = 80, spd = 16.5, castSpd = 1.2, size = 3, stamina = 18, energy = 25, recoverStamina = 1.3, recoverEnergy = 2.4 },
